...
class Citadel_GunFireSmoke: Actor
{
    Default
	{
        Alpha 0.75;
...
class Citadel_Smoke : Actor abstract
{
	...
	Default
	{
		Citadel_Smoke.GrowSpeed 0.00275, 0.003;
		Citadel_Smoke.FadeSpeed 0.00275, 0.003;
		Citadel_Smoke.StopSpeed 0.95, 0.95;
		Citadel_Smoke.GrowStopFactor 0.98;
		Radius 5;
		Height 10;
		Scale 0.02;
		Gravity 0.022;
...
class Citadel_ExplosionSmoke : Citadel_Smoke
{
	Default
	{
		Scale 0.4;
		Citadel_Smoke.FadeSpeed 0.003, 0.007;
		Citadel_Smoke.GrowSpeed 0.006, 0.010;
		Citadel_Smoke.StopSpeed 0.80, 0.88;
	}
